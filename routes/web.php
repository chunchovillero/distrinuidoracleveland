...
Route::get('/manifest.json', function () { return response()->json(['name'=>'Sistema POS','short_name'=>'POS','id'=>'cleveland-pos','start_url'=>'/admin','scope'=>'/','display'=>'standalone','theme_color'=>'#000000','background_color'=>'#000000','icons'=>[['src'=>'/pwa-icon-192.png','sizes'=>'192x192','type'=>'image/png','purpose'=>'any maskable'],['src'=>'/pwa-icon-512.png','sizes'=>'512x512','type'=>'image/png','purpose'=>'any maskable']]]); });
Route::get('/pwa-icon-{size}.png', function ($size) { abort_unless(in_array((int)$size, [192,512], true), 404); return response()->file(storage_path('app/public/pwa-'.$size.'.png'), ['Content-Type'=>'image/png']); });
